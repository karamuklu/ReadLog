...
namespace ServiceReference1
{
    ...
    public interface IMailService
    {
        ...
        System.Threading.Tasks.Task MailGonderAsync(string takmaAd, ServiceReference1.SmtpDeliveryMethod smtpDeliveryMethod, bool useDefaultCredentials, bool enableSsl, string mailKonu, bool isBodyHtml, ServiceReference1.MailPriority mailPriority, string icerik, string[] kime, string bilgiMail);
        ...
        System.Threading.Tasks.Task MailYollaAsync(string mailKonu, string[] kime, string bilgiMail, bool isBodyHtml, string icerik, ServiceReference1.MailPriority mailPriority);
        ...
        System.Threading.Tasks.Task MailGonderAttachmentAsync(string takmaAd, ServiceReference1.SmtpDeliveryMethod smtpDeliveryMethod, bool useDefaultCredentials, bool enableSsl, string mailKonu, bool isBodyHtml, ServiceReference1.MailPriority mailPriority, string icerik, string kime, string bilgiMail, string[] dosyaYolu, string mailYollayan);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface IMailServiceChannel : ServiceReference1.IMailService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class MailServiceClient : System.ServiceModel.ClientBase<ServiceReference1.IMailService>, ServiceReference1.IMailService
    {
        ...
        public System.Threading.Tasks.Task MailGonderAsync(string takmaAd, ServiceReference1.SmtpDeliveryMethod smtpDeliveryMethod, bool useDefaultCredentials, bool enableSsl, string mailKonu, bool isBodyHtml, ServiceReference1.MailPriority mailPriority, string icerik, string[] kime, string bilgiMail)
        {
        ...
        public System.Threading.Tasks.Task MailYollaAsync(string mailKonu, string[] kime, string bilgiMail, bool isBodyHtml, string icerik, ServiceReference1.MailPriority mailPriority)
        {
        ...
        public System.Threading.Tasks.Task MailGonderAttachmentAsync(string takmaAd, ServiceReference1.SmtpDeliveryMethod smtpDeliveryMethod, bool useDefaultCredentials, bool enableSsl, string mailKonu, bool isBodyHtml, ServiceReference1.MailPriority mailPriority, string icerik, string kime, string bilgiMail, string[] dosyaYolu, string mailYollayan)
        {
